...
int main ()
{
  ...
  reader.read ("PointCloudICP.pcd", *cloud);
  ...
  else
  {
    ...
    pcl::visualization::PointCloudColorHandlerCustom<PointT> color(cloud_cylinder, 255, 0, 0);
    viewer->addPointCloud(cloud_cylinder,color,"Outliers");
    //viewer->addPointCloud(cloud_filtered2,"Inliers");
